...
<a href="{{route('admin.dashboard')}}"><img src="{{asset('back/img/icons/dashboard.svg')}}" alt="img"><span> Dashboard</span> </a>
</li>
...
@php
    ...
    foreach ($productMenuRoutes as $route) {
        if (request()->routeIs($route)) {
            $isProductMenuActive = true;
            break;
        }
    }
@endphp
...
<li class="submenu ">
    <a href="javascript:void(0);" class="{{ $isProductMenuActive ? 'active' : '' }}">
        <img src="{{ asset('back/img/icons/product.svg') }}" alt="img">
        <span> Product</span>
